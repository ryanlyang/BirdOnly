...
from setv.fusion.artifacts import build_exact_fusion_artifacts
...
def main() -> int:
    ...
    parser.add_argument("--exact-expert-dir", required=True)
    ...
    config = load_fusion_config(
        ...
        exact_expert_dir=args.exact_expert_dir,
        output_root=args.output_root,
        allow_expert_sanity_warnings=args.allow_expert_sanity_warnings,
    )
    destination = build_exact_fusion_artifacts(config)
